...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,120.906,95}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {5000,5000,500,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define MEASURED_UPPER_LIMIT          3.0  //upper limit factor used for sensor reading validation in mm
